...
Public Class FormPortCfg
    '-----------------------------------------------------
    ' Initialization -------------------------------------
    '-----------------------------------------------------
    Private Sub FormPortCfg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cboxBaudRate.SelectedIndex = 2 'Define 9600 as default
